      ...
      <SheetContent className="w-full px-4 sm:max-w-2xl overflow-y-auto">
        <SheetHeader className="space-y-4">
          <div className="relative w-full h-48 rounded-lg overflow-hidden">
            <img
              src={job.backgroundUrl || "/placeholder.svg"}
              alt="Office"
          ...
          <div className="space-y-3">
            ...
            <div className="pl-10">
              ...
              <ul className="space-y-2">
                {[...job.benefits.offer, ...job.benefits.rights]
                  .filter(Boolean)
                  .map((benefit, index) => (
                    <li
                      key={index}
                ...
                {[...job.benefits.offer, ...job.benefits.rights].filter(Boolean)
                  .length === 0 && (
