...
const CompanyHiringJobs: React.FC<CompanyHiringJobsProps> = ({ jobs, companyName, onViewAll }) => {
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-2">
          ...
          <h3 className="font-semibold text-gray-900">
            Việc Làm Đang Tuyển tại {companyName}
          </h3>
        </div>
                  ...
                  <div className="flex items-center justify-between mt-2">
                    ...
                    {job.numberOfApplications > 0 && (
                      <div className="flex items-center gap-1 text-xs text-gray-600 bg-gray-100 px-2 py-1 rounded-full">
                        ...
                        <span className="font-medium">{job.numberOfApplications}</span>
                        <span className="text-[10px]">ứng viên</span>
                      </div>
                    )}
                  </div>
                </div>
