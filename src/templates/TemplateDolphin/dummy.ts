...
export const templateDolphinDummyVi: ResumeData = {
  basicInfo: {
    ...
    profilePhoto: "/template_avatar/default4.jpg",
    customFields: [
...
// English dummy data
export const templateDolphinDummyEn: ResumeData = {
  basicInfo: {
    ...
    profilePhoto: "/template_avatar/default4.jpg",
    customFields: [
      { type: "FACEBOOK", value: "facebook.com/markanderson" },
      { type: "INSTAGRAM", value: "instagram.com/markanderson" },
    ],
  },
  objective: {
    description:
  ...
  experience: [
    {
      isHidden: false,
      order: 1,
      company: "Pacific Furniture Corp.",
    ...
    },
    {
      isHidden: false,
      order: 2,
      company: "Northwest Trading Services",
      position: "Sales Representative",
      startDate: "Jun 2020",
      endDate: "Feb 2022",
      description:
  ...
  references: [
    {
      isHidden: false,
      order: 1,
      information: "Christopher Brown - Sales Director at Pacific Furniture",
      description:
        "Email: chris.brown@pacificfurniture.com | Phone: (555) 123-4321",
    },
    {
      isHidden: false,
      order: 2,
      information: "Amanda White - Sales Manager at Northwest Trading",
      description:
        "Email: amanda.white@northwesttrading.com | Phone: (555) 567-8765",
    },
  ],
  interests: {
    isHidden: false,
...
export const templateDolphinDummy = templateDolphinDummyVi;
