...
export default function EmployerHome() {
  ...
  return (
    <div className="h-screen bg-white overflow-hidden">
      {/* Hero Section */}
      <section className="relative h-full overflow-hidden" style={{ 
            ...
            <div className="space-y-7">
              ...
              >
                <h1 className="text-5xl lg:text-[64px] font-bold leading-[1.15]">
                  ...
                  <br />
                  <span className="text-[#1e3a5f]">to Hire Top Talent</span>
                </h1>
                
                <p className="text-[17px] text-[#66789c] leading-relaxed max-w-[520px]">
                  Connect with over 3 million qualified candidates. Post your job and start receiving applications from top talent within 24 hours.
                </p>
              </div>
              ...
              >
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-gray-100/80 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-0.5">3M+</h3>
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-gray-100/80 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-0.5">60%</h3>
                  <p className="text-xs text-gray-600">Faster Hire</p>
                </div>
                ...
                <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-4 border border-gray-100/80 shadow-md hover:shadow-lg transition-all duration-300 hover:-translate-y-1 group">
                  ...
                  <h3 className="text-lg font-bold text-gray-900 mb-0.5">95%</h3>
