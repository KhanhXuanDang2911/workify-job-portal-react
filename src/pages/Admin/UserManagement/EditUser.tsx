...
const schema = z.object({
  ...
  gender:
     z.enum(Object.keys(GENDER_ENUM)as [keyof typeof GENDER_ENUM])
    .optional()
...
export default function EditUser() {
  ...
  return (
    <div className="max-w-5xl mx-auto p-6 bg-white border-1 rounded-lg my-6">
      <Button variant="ghost" onClick={() => navigate(`${admin_routes.BASE}/${admin_routes.USERS}`, { state: { refresh: true } })} className="mb-4">
